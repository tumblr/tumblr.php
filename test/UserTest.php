...
class UserTest extends TumblrTest
{
    ...
    public function providerCalls2()
    {
        return array(
            ...
            // getUserInfo
            array(function ($c) { $c->getUserInfo(); }, 'GET', 'v2/user/info', []),

            // getDashboardPosts
            array(function ($c) { $c->getDashboardPosts(); }, 'GET', 'v2/user/dashboard', []),
            array(function ($c) { $c->getDashboardPosts(array('limit' => 10)); }, 'GET', 'v2/user/dashboard', array('limit' => 10)),

            // getFollowedBlogs
            array(function ($c) { $c->getFollowedBlogs(); }, 'GET', 'v2/user/following', []),
            array(function ($c) { $c->getFollowedBlogs(array('limit' => 10)); }, 'GET', 'v2/user/following', array('limit' => 10)),

            // getLikedPosts
            array(function ($c) { $c->getLikedPosts(); }, 'GET', 'v2/user/likes', []),
            array(function ($c) { $c->getLikedPosts(array('limit' => 10)); }, 'GET', 'v2/user/likes', array('limit' => 10)),
